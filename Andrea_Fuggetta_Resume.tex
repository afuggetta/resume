...
\begin{center}
    ...
    Cincinnati, OH 45249 \\ \vspace{1pt}
     347-208-3191 \ $|$ \ afuggetta@gmail.com \\ \vspace{1pt} % Recommended not to include email link or other hyperlinks in resume PDF submitted to USAJobs
\end{center}

Veteran's Preference: N/A\ $|$ \ Federal Employment Status: N/A\ $|$ \ Citizenship: United States % List your veteran's preference, fed employment status, and current citizenship. Put N/A if one of these does not apply to you
